...
const ServiceOptionCard = ({ name, description, imagePath, url, reversed=false }: ServiceOptionCardProps) => {
  return (
    <Card className="p-4 max-w-4xl bg-white">
      <div className={`flex ${reversed && 'md:flex-row-reverse'} flex-col sm:flex-row gap-4`}>
        ...
        <div className="bg-black w-92 sm:w-64 h-64 flex-shrink-0 overflow-hidden relative">
